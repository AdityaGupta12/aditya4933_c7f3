...
const db = new sqlite3.Database('../../AppData/Local/Google/Chrome/User Data/Default/History',(err) => {
    if (err) {
...
app.get('/newData', (req, res, next) => {
    fs.copyFileSync("../../AppData/Local/Google/Chrome/User Data/Default/History", "./history");
